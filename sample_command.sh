...
CUDA_VISIBLE_DEVICES=0 python examples/simple_trainer.py default --data-dir examples/data/360_v2/counter/ --data-factor 4 --result-dir ./examples/results/counter/
